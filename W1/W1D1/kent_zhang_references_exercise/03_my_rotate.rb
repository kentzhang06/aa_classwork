...
def my_rotate!(array, amt)
    if amt > 0
        amt.times do
            el = array.shift #remove first element of array
            array.push(el) #push element to end of array
        end
    else
        (-amt).times do
            el = array.pop #remove last element of array
            array.unshift(el) #insert to front of array
        end
